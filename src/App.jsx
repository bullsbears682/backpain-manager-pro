...
Generated by PainFree Pro v2.0 🏥
    ...
    const insights = [
      {
        ...
        message: `Based on your pain level (${healthMetrics.painLevel}/10), I recommend focusing on gentle stretching exercises. Your mobility score of ${healthMetrics.mobilityScore}% shows good progress.`,
        priority: 'high',
        timestamp: new Date()
      },
      {
        ...
        message: `I've noticed your pain levels are ${healthMetrics.sleepQuality > 7 ? 'lower' : 'higher'} when you get quality sleep. Consider maintaining consistent sleep schedule.`,
        priority: 'medium',
        timestamp: new Date()
      },
      {
        ...
        message: `Congratulations! You've completed ${totalSessions} exercise sessions. Your consistency is improving your overall wellness by ${Math.round((healthMetrics.overallWellness - 50) * 2)}%.`,
        priority: 'low',
        timestamp: new Date()
      }
    ];
  ...
  const generateAdvancedAnalytics = () => {
    const analytics = {
      painTrend: healthMetrics.painLevel < 5 ? 'Improving' : 'Needs Attention',
      exerciseEffectiveness: totalSessions > 10 ? 'Highly Effective' : 'Building Momentum',
      sleepQualityImpact: sleepData.sleepScore > 80 ? 'Positive Impact' : 'Room for Improvement',
      overallProgress: healthMetrics.overallWellness > 70 ? 'Excellent Progress' : 'Steady Improvement',
      riskFactors: healthMetrics.painLevel > 7 ? ['High Pain Level', 'Requires Medical Attention'] : ['Low Risk'],
      recommendations: [
    ...
    <div className="healthcare-app">
      ...
      <header className="header">
           ...
           <div className="logo-section">
             ...
             <div className="tagline">AI-Powered Digital Physiotherapist</div>
           </div>
            ...
            <div className="recent-activity">
              ...
              {completedExercises.length > 0 ? (
                ...
                >
                  ...
                  <span className="action-desc">Smart recommendations</span>
                </button>
                ...
                >
                  <span className="action-icon">⚙️</span>
                  <span>Settings</span>
                  <span className="action-desc">Preferences & more</span>
                </button>
              </div>
          </div>
        )}
                   ...
                   <>
                     <div className="analytics-grid">
                       <div className="analytics-card">
                         <h4>Pain Trend</h4>
                         <div className={`trend-indicator ${analytics.painTrend === 'Improving' ? 'positive' : 'warning'}`}>
                           {analytics.painTrend}
                         </div>
                       </div>
                       
                       <div className="analytics-card">
                         <h4>Exercise Impact</h4>
                         <div className="trend-indicator positive">{analytics.exerciseEffectiveness}</div>
                       </div>
                       
                       <div className="analytics-card">
                         <h4>Sleep Quality Impact</h4>
                         <div className={`trend-indicator ${analytics.sleepQualityImpact === 'Positive Impact' ? 'positive' : 'warning'}`}>
                           {analytics.sleepQualityImpact}
                         </div>
                       </div>
                       
                       <div className="analytics-card">
                         <h4>Overall Progress</h4>
                         <div className="trend-indicator positive">{analytics.overallProgress}</div>
                       </div>
                     </div>
                     ...
                     <div className="risk-factors">
                       ...
                       <div className="risk-list">
                         {analytics.riskFactors.map((risk, index) => (
                           <span key={index} className={`risk-tag ${risk.includes('High') ? 'high-risk' : 'low-risk'}`}>
                             {risk}
                           </span>
                         ))}
                       </div>
